 ...
 *
 * Exports (window.InventoryController):
...
(function () {
  ...
  function addPotion(ctx, heal = 3, name = `potion (+${heal} HP)`) {
  ...
  function drinkByIndex(ctx, idx, hooks) {
    const P = (ctx && ctx.Player) || (typeof window !== "undefined" ? window.Player : null);
  ...
  function equipByIndex(ctx, idx, hooks) {
    const P = (ctx && ctx.Player) || (typeof window !== "undefined" ? window.Player : null);
  ...
  function equipByIndexHand(ctx, idx, hand, hooks) {
    const P = (ctx && ctx.Player) || (typeof window !== "undefined" ? window.Player : null);
    if (P && typeof P.equipItemByIndex === "function") {
      P.equipItemByIndex(ctx.player, idx, {
        log: ctx.log,
  ...
  function unequipSlot(ctx, slot, hooks) {
    const P = (ctx && ctx.Player) || (typeof window !== "undefined" ? window.Player : null);
