...
(() => {
  ...
  // Mouse/click support moved to ui/click_handlers.js
  try { if (window.ClickHandlers && typeof window.ClickHandlers.init === "function") window.ClickHandlers.init(); } catch (_) {}
