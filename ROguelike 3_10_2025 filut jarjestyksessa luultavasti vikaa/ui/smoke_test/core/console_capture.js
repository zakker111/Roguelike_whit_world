// SmokeTest Console Capture (smoke_test)
// Wraps console.error/warn and window error handlers; provides reset/snapshot.
...
(function () {
  ...
  window.SmokeCore.ConsoleCapture = ConsoleCapture;
})();