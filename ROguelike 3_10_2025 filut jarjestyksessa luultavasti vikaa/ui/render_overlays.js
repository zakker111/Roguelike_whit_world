 ...
 */
(function () {
  function drawTownDebugOverlay(ctx, view) {
  ...
  function drawTownPaths(ctx, view) {
  ...
  function drawTownHomePaths(ctx, view) {
  ...
  function drawTownRoutePaths(ctx, view) {
  ...
  function drawLampGlow(ctx, view) {
    try {
      const time = ctx.time;
