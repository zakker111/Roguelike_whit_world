...
import { townNPCsAct } from "./town_runtime.js";

  function townNPCsActWrapper(ctx) {
  ...
  export { populateTown, townNPCsActWrapper as townNPCsAct, checkHomeRoutes };
  if (typeof window !== "undefined") {
    window.TownAI = {
      populateTown,
      townNPCsAct: townNPCsActWrapper,
      checkHomeRoutes,
    };
  }