// DOM helpers and lightweight UI for smoketest
// Exposes window.SmokeDOM with: ensureBanner, ensureStatusEl, currentMode, log, panelReport, appendToPanel, setStatus

(function () {
  if (window.SmokeDOM) return;
  ...
  window.SmokeDOM = { ensureBanner, ensureStatusEl, currentMode, setStatus, log, panelReport, appendToPanel };
})();