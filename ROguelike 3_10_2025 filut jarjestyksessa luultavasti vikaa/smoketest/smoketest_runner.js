  ...
  async function boot() {
    ...
    async function runOnce(seedOverride) {
      ...
      try {
        ...
        // NOTE: To keep this commit focused on chopping helpers into folders, the rest of the runner
        // remains unchanged in behavior. All helper calls are now via modules above.
        // ---- ORIGINAL FLOW CONTINUES BELOW (unaltered, but using helpers) ----pcs.length) {
