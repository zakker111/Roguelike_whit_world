    ...
    try {
      ...
      for (let i = 0; i < pipeline.length; i++) {
        ...
        try {
          ...
          if (Banner && typeof Banner.log === "function") Banner.log("Scenario failed: " + step.name, "b              try { if (window.UI && typeof window.UI.hideGod === "function") window.UI.hideGod(); } catch (_) {}
              try {
