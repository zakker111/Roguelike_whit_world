  ...
  const Render = {
    ...
    buildKeyChecklistHtmlFromSteps(steps) {
      ...
      const keyChecks = [
        ...
        { label: "Returned to overworld from dungeon", pass: hasAny(["Returned to overworld from dungeon", "Dungeon exit helper: post-'g' mode=world", "Dungeon exit helper: final mode=world [forceWorld]", "Mode confirm (dungeon exit): world"]) },
