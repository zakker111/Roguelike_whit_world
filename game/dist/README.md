...
- Default encounter rate is 50% (tunable via the GOD panel “Encounter rate” slider; persists), tuned to produce roughly one overworld encounter every 30–50 movement tiles.
